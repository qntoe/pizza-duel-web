...
const InfinexIcon = Iconic.createIconic({
    alt: 'Infinex Wallet',
    iconName: 'infinex',
...
const TronLinkIcon = Iconic.createIconic({
    alt: 'TronLink Wallet',
    iconName: 'tronlink',
...
const PontemIcon = Iconic.createIconic({
    alt: 'Pontem',
    iconName: 'pontem',
    sourcePath: 'icons/wallets/pontem.svg',
});
const LobstrIcon = Iconic.createIconic({
    alt: 'Lobstr',
    iconName: 'lobstr',
    sourcePath: 'icons/wallets/lobstr.svg',
});
const FreighterIcon = Iconic.createIconic({
    alt: 'Freighter',
    iconName: 'freighter',
...
exports.TronLinkIcon = TronLinkIcon;
