...
/**
 * The following exports are using the direct file path to avoid an circular dependency
 * issue where the module system fails to resolve some hooks.
 *
 * The issue will be solved with this ticket
 * https://linear.app/dynamic-labs/issue/QNTM-3636/remove-circular-imports-in-sdk-react-core
 */
export { getAuthToken } from './lib/client/extension/functions/getAuthToken';
export { getMinAuthToken } from './lib/client/extension/functions/getMinAuthToken';
export { useProjectSettings } from './lib/client/extension/projectSettings/useProjectSettings';
...
export { usePayWithDynamic, type PayWithDynamicProps, } from './lib/utils/hooks/usePayWithDynamic';
