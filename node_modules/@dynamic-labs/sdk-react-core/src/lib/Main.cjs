...
const Main = () => {
    ...
    React.useEffect(() => {
        const newToWeb3WalletKey = utils.StorageService.getItem(localStorage.NEWTOWEB3_WALLET_EXTENSION_FLAG_KEY);
        if ((walletConnectorOptions === null || walletConnectorOptions === void 0 ? void 0 : walletConnectorOptions.length) && newToWeb3WalletKey) {
            ...
            utils.StorageService.removeItem(localStorage.NEWTOWEB3_WALLET_EXTENSION_FLAG_KEY);
        }
    }, [walletConnectorOptions]);
    const showDynamicAuth = showAuthFlow && Boolean(projectSettings);
    return (jsxRuntime.jsx(index.FooterAnimationContextProvider, { children: jsxRuntime.jsx(Portal.Portal, { zIndex: index$1.authModalZIndex, isShown: showDynamicAuth, handleClose: handleClose, withBackdrop: true, transitionEvents: {
                ...
                onUnmount: handleOnPortalUnmount,
                    ...
                    }, onClose: handleClose, projectSettings: projectSettings, children: jsxRuntime.jsx(RenderView.RenderView, {}) }) }) }) }));
};
