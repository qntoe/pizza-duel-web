...
const RetrySendVerificationCodeSection = ({ retryHandler, secondsToRetry = 15, disabled = false, className }) => {
    ...
    if (retried) {
        return (jsxRuntime.jsxs("div", { className: containerClassName, children: [jsxRuntime.jsx(Typography.Typography, { variant: 'body_small', color: 'secondary', copykey: 'dyn_otp_verification.resend_code_in', children: t('dyn_otp_verification.resend_code_in', { remainingSeconds }) }), jsxRuntime.jsxs("span", { className: 'retry-send-verification-code-section__confirmation', children: [jsxRuntime.jsx(Icon.Icon, { color: 'success-1', children: jsxRuntime.jsx(checkCircle.ReactComponent, {}) }), jsxRuntime.jsx(Typography.Typography, { variant: 'body_small', weight: 'medium', color: 'primary', copykey: 'dyn_otp_verification.code_sent', children: t('dyn_otp_verification.code_sent') })] })] }));
    }
    return (jsxRuntime.jsxs("div", { className: containerClassName, children: [jsxRuntime.jsx(Typography.Typography, { variant: 'body_small', weight: 'medium', color: 'secondary', copykey: 'dyn_otp_verification.code_not_received', className: 'retry-send-verification-code-section__not-received', children: t('dyn_otp_verification.code_not_received') }), jsxRuntime.jsx(TextButton.TextButton, { className: 'email-verification__text-button', disabled: isLoading || disabled, onClick: () => retry(), copykey: 'dyn_otp_verification.resend_code', children: t('dyn_otp_verification.resend_code') })] }));
};
