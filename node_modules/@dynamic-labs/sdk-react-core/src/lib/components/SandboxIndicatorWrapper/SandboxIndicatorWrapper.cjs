...
const SandboxIndicatorWrapper = ({ children, }) => {
    ...
    const isSandBox = (projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.environmentName) === sdkApiCore.EnvironmentEnum.Sandbox;
    ...
    return (jsxRuntime.jsxs("div", { style: { position: 'relative' }, children: [jsxRuntime.jsx("div", { ref: indicatorRef, 
                ...
                }, "data-testid": 'sandbox-indicator', children: capitalize.capitalize((projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.environmentName) || '') }), children] }));
};
