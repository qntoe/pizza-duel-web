...
var WalletDelegationView = require('../../../../views/WalletDelegation/WalletDelegationView/WalletDelegationView.cjs');
...
const mapViewToComponent = {
    ...
    'crypto-com-onramp': CryptoComOnramp.CryptoComOnramp,
