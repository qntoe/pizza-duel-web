...
var index$1 = require('../../../../shared/utils/hooks/useOnClickOutside/index.cjs');
...
const DynamicUserProfile = ({ variant, }) => {
    ...
    const { setIsOpen, isOpen, widgetRef, inlineControlsRef } = DynamicWidgetContext.useWidgetContext();
...
const ShadowedDynamicUserProfile = ({ variant, }) => (jsxRuntime.jsx(ShadowDOM.ShadowDOM, { zIndex: index.widgetModalZIndex, children: jsxRuntime.jsx(DynamicUserProfile, { variant: variant }) }));
