...
const PendingSignContent = () => {
    ...
    if (selectedWalletConnector !== null) {
        if (walletConnectorCore.isEmailOTPWalletConnector(selectedWalletConnector)) {
            return (jsxRuntime.jsx(EmailOTPConnectorPendingSignModalContent.EmailOTPConnectorPendingSignModalContent, { walletConnector: selectedWalletConnector }));
        }
        if (walletConnectorCore.isEmailWalletConnector(selectedWalletConnector)) {
            return (jsxRuntime.jsx(EmailConnectorPendingSignModalContent.EmailConnectorPendingSignModalContent, { emailWalletConnector: selectedWalletConnector }));
        }
    }
    return jsxRuntime.jsx(DefaultPendingSignModalContent.DefaultPendingSignModalContent, {});
};
const PendingSignWidgetPortal = () => (jsxRuntime.jsx(WidgetPortal.WidgetPortal, { onClose: useCloseMultiWalletPrompt.useCloseMultiWalletPrompt(), children: jsxRuntime.jsx(PendingSignContent, {}) }));
const PendingSignModal = () => (jsxRuntime.jsx(PromptModal.PromptModal, { onClose: useCloseMultiWalletPrompt.useCloseMultiWalletPrompt(), children: jsxRuntime.jsx(PendingSignContent, {}) }));

exports.PendingSignModal = PendingSignModal;
exports.PendingSignWidgetPortal = PendingSignWidgetPortal;
