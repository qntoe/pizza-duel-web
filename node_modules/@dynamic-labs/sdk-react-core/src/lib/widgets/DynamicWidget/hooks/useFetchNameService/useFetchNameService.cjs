...
const useFetchNameService = ({ address, chain, } = {}) => {
    ...
    const verifiedCredentials = (_a = useUser.useUserProfile()) === null || _a === void 0 ? void 0 : _a.verifiedCredentials;
    const vcNameService = React.useMemo(() => {
        var _a;
        if (!address || !chain)
            return undefined;
        return (_a = getWalletVerifiedCredential.getWalletVerifiedCredential(address, verifiedCredentials, chain)) === null || _a === void 0 ? void 0 : _a.nameService;
