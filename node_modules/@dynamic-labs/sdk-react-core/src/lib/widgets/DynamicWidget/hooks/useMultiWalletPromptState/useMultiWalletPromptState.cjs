...
const useMultiWalletPromptState = () => {
    const { accountSwitchState, multiWalletWidgetState, multiWallet, selectedWalletWithAction, } = useInternalDynamicContext.useInternalDynamicContext();
...
exports.useMultiWalletPromptState = useMultiWalletPromptState;
