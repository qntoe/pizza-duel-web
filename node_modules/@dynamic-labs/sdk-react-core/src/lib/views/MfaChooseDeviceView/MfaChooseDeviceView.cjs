...
var useGetMfaOptions = require('./useGetMfaOptions/useGetMfaOptions.cjs');
...
const MfaChooseDeviceView = ({ isInitialSetup = true, createMfaToken = false, }) => {
    ...
    const getMfaOptions = useGetMfaOptions.useGetMfaOptions(isInitialSetup);
    const { data: mfaOptions } = usePromise.usePromise(getMfaOptions, {
        deps: [isInitialSetup],
        initialData: [],
    });
