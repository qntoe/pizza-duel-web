...
const NoAccess = () => {
    ...
    const Icon = React.useMemo(() => {
        if (walletConnector) {
            return jsxRuntime.jsx(AuthProviderIcon.AuthProviderIcon, {});
        }
