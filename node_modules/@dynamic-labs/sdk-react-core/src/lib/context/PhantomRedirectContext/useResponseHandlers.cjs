...
var getPromptAmountParams = require('../../widgets/DynamicWidget/views/ChooseWalletFundingMethod/useFundingMethods/getPromptAmountParams/getPromptAmountParams.cjs');
...
const useResponseHandlers = () => {
    ...
    const { promptAmountAndFund } = useFundWithWallet.useInternalFundWithWallet();
    ...
    const handleConnectResponse = React.useCallback(() => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        ...
        if ((connectionType === null || connectionType === void 0 ? void 0 : connectionType.connectorConsumed) &&
            ...
            if (!connectionType.initiatedByWidget)
                return;
            const props = getPromptAmountParams.getPromptAmountParams({ wallet });
