...
const MockContextProvider = ({ children, view, customerTheme, dynamicLayoutClassName, }) => {
    ...
    return (jsxRuntime.jsx(MockContext.Provider, { value: { mockedSDK: true }, children: jsxRuntime.jsx(PopperContext.PopperProvider, { children: jsxRuntime.jsx(ViewContext.ViewContext.Provider, { value: viewContextValue, children: jsxRuntime.jsx(ErrorContext.ErrorContextProvider, { children: jsxRuntime.jsx(ThemeContext.ThemeContextProvider, { customerTheme: customerTheme, children: jsxRuntime.jsx(index.FooterAnimationContextProvider, { children: jsxRuntime.jsx(walletBook.WalletBookContextProvider, { walletBook: index$1.walletBookMock, children: jsxRuntime.jsx(MockContextWrapper, { dynamicLayoutClassName: dynamicLayoutClassName, children: children }) }) }) }) }) }) }) }));
};
