...
const SendBalanceContextProvider = ({ children, }) => {
    ...
    const openSendBalanceModal = React.useCallback((props) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        return open((resolve, reject) => {
            ...
            if (!walletConnectorCore.isSendBalanceWalletConnector(primaryWallet.connector)) {
    ...
    return (jsxRuntime.jsxs(SendBalanceContext.Provider, { value: { open: openSendBalanceModal }, children: [modal, children] }));
};
const useSendBalance = () => {
    ...
    const passkeyContext = React.useContext(PasskeyContext.PasskeyContext);
