...
const useWalletDelegation = () => {
    ...
    const delegateKeyShares = React.useCallback((wallets, password) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        if (!delegatedAccessEnabled) {
    ...
    const revokeDelegation = React.useCallback((wallets, password) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        ...
        for (const wallet of wallets) {
            ...
            try {
                ...
                logger.logger.error('Failed to revoke delegation:', {
                    error,
                    wallet,
                });
            }
