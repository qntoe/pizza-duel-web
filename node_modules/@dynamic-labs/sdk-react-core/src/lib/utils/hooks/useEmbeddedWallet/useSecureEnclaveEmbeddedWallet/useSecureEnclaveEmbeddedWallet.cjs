...
const useSecureEnclaveEmbeddedWallet = () => {
    ...
    const createPasskey = React.useCallback((options) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        ...
        validateTurnkeyProviderEnabled.validateTurnkeyProviderEnabled(projectSettings);
        const turnkeyWallet = findTurnkeyWallet.findTurnkeyWalletByPrimaryChain(walletConnectorOptions, (_t = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.sdk.embeddedWallets) === null || _t === void 0 ? void 0 : _t.chainConfigurations, user$1.verifiedCredentials);
     ...
     */
    const revealEmbeddedWalletKey = React.useCallback((_v) => _tslib.__awaiter(void 0, [_v], void 0, function* ({ type, htmlContainerId, }) {
        ...
        const turnkeyWallet = findTurnkeyWallet.findTurnkeyWalletByPrimaryChain(walletConnectorOptions, (_w = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.sdk.embeddedWallets) === null || _w === void 0 ? void 0 : _w.chainConfigurations, user$1 === null || user$1 === void 0 ? void 0 : user$1.verifiedCredentials);
