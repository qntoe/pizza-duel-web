...
require('react-dom');
var findEmailOtpWalletConnector = require('../../../views/Passkey/utils/findEmailOtpWalletConnector/findEmailOtpWalletConnector.cjs');
...
const useEmailProvider = () => {
    const { projectSettings, walletConnectorOptions } = useInternalDynamicContext.useInternalDynamicContext();
    const { connectWithEmail } = useConnectWithOtp.useConnectWithOtp();
    ...
    const connectWithEmailFlow = React.useCallback((emailInput, onSuccess) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        var _a;
