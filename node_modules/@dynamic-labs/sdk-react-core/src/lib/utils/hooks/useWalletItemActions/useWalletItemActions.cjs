...
var useHandleWalletItem = require('./useHandleWalletItem/useHandleWalletItem.cjs');
...
const useWalletItemActions = () => {
    const { setMultiWalletWidgetState } = useInternalDynamicContext.useInternalDynamicContext();
    ...
    const handleExtensionAndCustodial = (_a) => _tslib.__awaiter(void 0, [_a], void 0, function* ({ requiresTwoStepAuthentication, walletConnector, }) {
        ...
        if (requiresTwoStepAuthentication || authMode$1 === 'connect-only') {
