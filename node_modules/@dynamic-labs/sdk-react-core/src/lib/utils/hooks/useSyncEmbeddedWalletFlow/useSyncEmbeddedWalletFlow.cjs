            ...
            if (shouldSyncCreateWallet) {
                ...
                try {
                    ...
                    if (error instanceof utils.EmbeddedWalletException) {
                        logger.logger.debug('[useSyncEmbeddedWalletFlow][EmbeddedWalletException] Error creating embedded wallet', error);
                    }
                    else {
                        logger.logger.error('[useSyncEmbeddedWalletFlow] Error creating embedded wallet', error);
                    }
