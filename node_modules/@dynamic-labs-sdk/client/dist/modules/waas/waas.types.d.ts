...
export type WaasProvider = {
    ...
    delegateKeyShares: (args: {
        password?: string;
        walletAccount: WalletAccount;
    }) => Promise<void>;
    exportClientKeyshares: (args: {
        password?: string;
        walletAccount: WalletAccount;
    }) => Promise<void>;
    ...
    refreshWalletAccountShares: (args: {
        password?: string;
        walletAccount: WalletAccount;
    }) => Promise<void>;
...
export type WaasWalletProvider = WalletProvider & Omit<WaasProvider, 'signMessage'>;
