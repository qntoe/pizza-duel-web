...
var NotWaasWalletProviderError = class extends require_constants.BaseError {
...
*/
const backupWaasKeySharesToGoogleDrive = async ({ password, walletAccount }, client = require_constants.getDefaultClient()) => {
...
*/
const delegateWaasKeyShares = async ({ password, walletAccount }, client = require_constants.getDefaultClient()) => {
...
*/
const exportWaasClientKeyshares = async ({ password, walletAccount }, client = require_constants.getDefaultClient()) => {
...
*/
const exportWaasPrivateKey = async ({ displayContainer, password, walletAccount }, client = require_constants.getDefaultClient()) => {
...
const userHasEmbeddedWalletForChain = ({ user, chain }) => {
	return user.verifiedCredentials.some((vc) => vc.walletProvider === _dynamic_labs_sdk_api_core.WalletProviderEnum.EmbeddedWallet && vc.chain && require_constants.getChainFromVerifiedCredentialChain(vc.chain) === chain);
};
...
*/
const isDynamicWaasEnabled = (client = require_constants.getDefaultClient()) => {
...
*/
const getChainsMissingWaasWalletAccounts = (client = require_constants.getDefaultClient()) => {
	const projectSettings = client.projectSettings;
	require_constants.assertDefined(projectSettings, "Project settings are not available");
...
*/
const hasDelegatedAccess = ({ walletAccount }, client = require_constants.getDefaultClient()) => {
	...
	require_constants.assertDefined(verifiedCredential, "Verified credential not found for Waas wallet account");
...
*/
const isPasswordRequiredForWaasWallets = (client = require_constants.getDefaultClient()) => {
	const { user } = client;
...
*/
const refreshWaasWalletAccountShares = async ({ walletAccount, password }, client = require_constants.getDefaultClient()) => {
...
*/
const revokeWaasDelegation = async ({ password, walletAccount }, client = require_constants.getDefaultClient()) => {
...
*/
const shouldAutoCreateWalletForChain = ({ chain }, client = require_constants.getDefaultClient()) => {
	require_constants.assertDefined(client.projectSettings, "Project settings are not available");
...
*/
const updateWaasPassword = async ({ currentPassword, newPassword, walletAccount }, client = require_constants.getDefaultClient()) => {
