import { C as getDefaultClient, D as getCore, E as BaseError, c as createApiClient } from "./constants-B8WQGUki.esm.js";
import { r as updateAuthFromVerifyResponse } from "./getVerifiedCredentialForWalletAccount-bYTdp3TE.esm.js";
...
const refreshAuth = async (client = getDefaultClient()) => {
	...
	const response = await createApiClient({}, client).refreshAuth({ environmentId: core.environmentId });
...
//# sourceMappingURL=NotWaasWalletAccountError-DJmbtj65.esm.js.map