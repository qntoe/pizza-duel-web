import type { AuthMode, BackupKeySharesToGoogleDriveRequest, BackupKeySharesToICloudRequest, CreateWalletAccountRequest, CreateWalletAccountResponse, DelegateKeySharesRequest, ExportClientKeysharesFromGoogleDriveRequest, ExportClientKeysharesRequest, ExportPrivateKeyRequest, GetWalletRecoveryStateRequest, GetWalletRequest, GetWalletResponse, GetWalletsRequest, IframeRequestMessages, ImportPrivateKeyRequest, IsPasswordEncryptedRequest, MessageTransportErrorResponse, OfflineExportPrivateKeyRequest, OfflineExportPrivateKeyResponse, RefreshWalletAccountSharesRequest, RequestWithTraceContext, RequiresPasswordForOperationRequest, ReshareRequest, RevokeDelegationRequest, SignMessageRequest, SignRawMessageRequest, SignTransactionRequest, SignTypedDataRequest, TraceContext, UnlockWalletRequest, UpdatePasswordRequest, VerifyPasswordRequest, WalletRecoveryState } from '@dynamic-labs-wallet/core';
...
export declare class iframeMessageHandler {
    ...
    signMessage(request: RequestWithTraceContext<SignMessageRequest>): Promise<string>;
    signRawMessage(request: RequestWithTraceContext<SignRawMessageRequest>): Promise<string>;
    signTransaction(request: RequestWithTraceContext<SignTransactionRequest>): Promise<string>;
    ...
    refreshWalletAccountShares(request: RequestWithTraceContext<RefreshWalletAccountSharesRequest>): Promise<void>;
    reshare(request: RequestWithTraceContext<ReshareRequest>): Promise<void>;
    exportPrivateKey(request: RequestWithTraceContext<ExportPrivateKeyRequest>): Promise<void>;
    ...
    signTypedData(request: RequestWithTraceContext<SignTypedDataRequest>): Promise<string>;
